    ...
    <div class="container">
        <div class="row data">
            <div class="col-lg-4 copy_right">
                ...
                <p> <?php echo $lang["footer_p2"]; ?> | <a
                        href="privacy_policy.php"><?php echo $lang["footer_p3"]; ?></a> </p>
            </div>
            ...
            <div class="col-lg-4 follow_us">
                ...
                <ul class="list-unstyled">
                    ...
                    <li> <a target="blank" href="https://www.youtube.com/channel/UCAHQ9iZzTQeO4VpIzIQpKzw/featured"> <i
