        ...
        VALUES (:zfirst_name , :zlast_name , :zemail , :zmobile ,
         ...
         :zproject_prize,:zusername,:zpassword)");
                        ...
                        if ($stmt) {
                            ...
                            $body =  $lang["artificial_register_message"];
            ...
            <div class='container'>
                <div class='alert alert-success text-center'> <?php echo $lang["artificial_register_message"]; ?>
                </div>
            </div>
            <?php
                        }
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="box mb-3">
                                    ...
                                    <textarea name="language_speak" class="form-control" name=""
                                        id="floatingInput"> <?php if ($_SERVER["REQUEST_METHOD"] == "POST") echo $_REQUEST['language_speak']; ?> </textarea>
                                        ...
                                        <div class="check_exp1_project">
                                            ...
                                            <div class="box mb-3">
                                                ...
                                                <textarea name="project_details" class="form-control" name=""
                                                    id="floatingInput"> <?php if ($_SERVER["REQUEST_METHOD"] == "POST") echo $_REQUEST['project_details']; ?> </textarea>
                                            ...
                                            <div class="box mb-3">
                                                ...
                                                <textarea name="project_tools" class="form-control" name=""
                                                    id="floatingInput">  <?php if ($_SERVER["REQUEST_METHOD"] == "POST") echo $_REQUEST['project_tools']; ?> </textarea>
                                            ...
                                            <div class="box mb-3">
                                                ...
                                                <input name="project_date" type="date" class="form-control"
                                                    id="floatingInput"
                                                    value="<?php if ($_SERVER["REQUEST_METHOD"] == "POST") echo $_REQUEST['project_date']; ?>">
                                ...
                                <div class="text">
                                    ...
                                    <div class="">
                                        <div class="reservation_button">
                                            <input onclick="reload()" type="submit" class="btn btn-primary"
