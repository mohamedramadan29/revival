...
<?php
$stmt = $connect->prepare("SELECT * FROM email_message_event WHERE email_section='انضم الي فريق'");
$stmt->execute();
        ...
        <div class="data">
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if (empty($errormessage)) {
                    ...
                    $stmt = $connect->prepare("INSERT INTO goin_team (first_name, last_name, email, mobile , country, message ,
                                ...
                                <div class="col-lg-6 col-12">
                                    ...
                                    <div class="box mb-3">
                                        ...
                                        <select name="choose_you" class="form-select country" id="floatingSelectGrid" aria-label="Floating label select example">
                                            ...
                                            ?>
                                            <?php
                                            $stmt = $connect->prepare("SELECT * FROM  form_selection_event WHERE select_form='انضم الي فريق'");
                                            $stmt->execute();
