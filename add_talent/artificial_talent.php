                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-12">
                                                                <div class="box mb-3">
                                                                    ...
                                                                    <input name="last_name" type="text" class="form-control" id="floatingInput" value="">
                                                                ...
                                                                <div class="box mb-3">
                                                                    ...
                                                                    <input name="specialist" type="text" class="form-control" id="floatingInput" value="">
                                                                </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="box mb-3">
                                            ...
                                            <textarea name="experience_info" class="form-control" name="" id="floatingInput"></textarea>

                                        </div>
                                        <div class="box mb-3">
                                            <label for="floatingInput"> <?php echo $lang["language_speak"] ?> </label>
                                            <textarea name="language_speak" class="form-control" name="" id="floatingInput"></textarea>
                                            ...
                                            <div class="main_check">
                                                ...
                                                <div class="check_exp1_project">
                                                    <div class="box mb-3">
                                                        ...
                                                        <input name="project_name" type="text" class="form-control" id="floatingInput" value="">
                                                    </div>
                                                    <div class="box mb-3">
                                                        <label for="floatingInput"> <?php echo $lang["about_project"]; ?>
                                                        </label>
                                                        <textarea name="project_details" class="form-control" name="" id="floatingInput"></textarea>
                                                    ...
                                                    <div class="box mb-3">
                                                        ...
                                                        <input name="project_field" type="text" class="form-control" id="floatingInput" value="">

                                                    </div>
                                                    <div class="box mb-3">
                                                        <label for="floatingInput"> <?php echo $lang["techniques_used"]; ?>
                                                        </label>
                                                        <textarea name="project_tools" class="form-control" name="" id="floatingInput"></textarea>

                                                    </div>
                                                    <div class="box mb-3">
                                                        <label for="floatingInput"> <?php echo $lang["project_date"]; ?>
                                                        </label>
                                                        <input name="project_date" type="date" class="form-control" id="floatingInput" value="">
                                                    ...
                                                    <div class="prototype_deisgn">
                                                        ...
                                                        <div class="check_prototype_resualt">
                                                            <div class="box mb-3">
                                                                ...
                                                                <textarea name="project_competation" class="form-control" id="floatingInput"></textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="prototype_deisgn">
                                                        ...
                                                        <div class="check_prototype_resualt">
                                                            <div class="box mb-3">
                                                                ...
                                                                <textarea name="project_prize" class="form-control" id="floatingInput"> </textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
