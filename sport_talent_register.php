        ...
        VALUES (:zfirst_name , :zlast_name , :zemail , :zmobile ,
         ...
         :zexperience_info, :zteam_name , :zteam_register, :zvideo_talent,:zfiels_talent,:zusername, :zpassword,:zpweight,:zpposition,:zptall)");
                        ...
                        if ($stmt) {
                            ...
                            $body =  $lang["sport_talent_register_message"];
            ...
            <div class='container'>
                <div class='alert alert-success text-center'> <?php echo $lang["sport_talent_register_message"]; ?>
                </div>
            </div>
            <?php
                        }
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-12">
                                            ...
                                            <div class="box mb-3">
                                                ...
                                                <input name="first_name2" type="text" class="form-control"
                                                    id="floatingInput"
                                                    value="<?php if ($_SERVER["REQUEST_METHOD"] == "POST") echo $_REQUEST['first_name2']; ?>">
                                            ...
                                            <div class="box mb-3">
                                                ...
                                                <label for="floatingInput"> <?php echo $lang["mobile"];  ?> <span
                                                        class="star"> *
                                                    </span></label>
                                        ...
                                        <div class="col-lg-6 col-12">
                                            ...
                                            <div class="box mb-3">
                                                ...
                                                <input name="specialist" type="text" class="form-control"
                                                    id="floatingInput"
                                                    value="<?php if ($_SERVER["REQUEST_METHOD"] == "POST") echo $_REQUEST['specialist']; ?>">

                                            </div>
                                            <div class="box mb-3">
                                                <label for="floatingInput"> <?php echo $lang["password"];  ?><span
                                                        class="star"> *
                                                    </span></label>
                                                <input name="password" type="password"
                                                    class="form-control passwordinput" id="floatingInput"
                                                    value="<?php if ($_SERVER["REQUEST_METHOD"] == "POST") echo $_REQUEST['password']; ?>">
                                                <i class="fa fa-eye"></i>
                                            </div>
                                            <div class="box mb-3">
                                                <label
                                                    for="floatingInput"><?php echo $lang["confirm_password"];  ?><span
                                                        class="star"> *
                                                    </span></label>
                                        ...
                                        <div class="check_exp1_project">
                                            <div class="form-group mb-3">
                                                ...
                                                <input name="team_name" type="text" class="form-control"
                                                    id="floatingInput"
                                                    value="<?php if ($_SERVER["REQUEST_METHOD"] == "POST") echo $_REQUEST['team_name']; ?>">

                                            </div>
                                            <!-- Do Design -->
                                            <div class="prototype_deisgn">
                                                <h4> هل انت مسجل رسميا بعقد في قائمة النادي؟!</h4>
                                                <input class="" name="team_register" type="radio" value=""
                                                    id="check_design1">
