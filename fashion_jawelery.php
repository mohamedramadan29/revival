...
<div class="hero artif">
    <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
        <div class="carousel-inner">
            <?php
            $stmt = $connect->prepare("SELECT * FROM revival_banner WHERE banner_page='الأزياء والمجوهرات' ORDER BY banner_id DESC LIMIT 1");
            $stmt->execute();
            ...
            <?php
            $stmt = $connect->prepare("SELECT * FROM revival_banner WHERE banner_page='الأزياء والمجوهرات' ORDER BY banner_id  LIMIT 2");
            $stmt->execute();
            ...
            <div class="row">
                <div class="col-lg-6 col-12">
                    <div class="info">
                        ...
                        <?php
                        $stmt = $connect->prepare("SELECT * FROM revival_about_us WHERE about_page ='الأزياء والمجوهرات' ORDER BY about_id LIMIT 1 ");
                        $stmt->execute();
...
<div class="contact_us  fashion_login">
    <div class="overlay">
        <div class="container">
            <div class="data">
                <h2><?php echo $lang["fash_int_register"] ?></h2>
                <p> <?php echo $lang["fash_int_p4"] ?>
                </p>
                <a href="fashion_register.php" class="btn button"> <?php echo $lang["fash_int_register_now"] ?></a>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="row">
                <div class="col-lg-4 col-12">
                    <div class="info">
                        ...
                        <h3> <?php echo $lang["fash_int_head4"] ?> </h3>
                        <ul class="list-unstyled">
                            <li> <?php echo $lang["fash_int_goal1"] ?> </li>
                            <li> <?php echo $lang["fash_int_goal2"] ?> </li>
                            <li> <?php echo $lang["fash_int_goal3"] ?> </li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-4 col-12">
                    <div class="info">
                        ...
                        <h3> <?php echo $lang["fash_int_head6"] ?> </h3>
                        <p><?php echo $lang["fash_int_vision"] ?> </p>
                    </div>
                </div>
                <div class="col-lg-4 col-12">
                    <div class="info">
                        <i class="fa-solid fa-handshake-angle"></i>
                        <h3> <?php echo $lang["fash_int_head7"] ?> </h3>
                        <p> <?php echo $lang["fash_int_message"] ?> </p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12 heading-section text-center ftco-animate mb-5">
                <h2 class="mb-2"> <?php echo $lang["fash_int_project"] ?> </h2>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="carousel-car owl-carousel">
                    ...
                    <div class="item">
                        <div class="car-wrap ftco-animate">
                            <div class="img d-flex align-items-end" style="background-image: url(uploads/fash3.jpg);">
                            </div>
                            <div class="text">
                    ...
                    <div class="item">
                        <div class="car-wrap ftco-animate">
                            <div class="img d-flex align-items-end" style="background-image: url(uploads/fash1.jpg);">
                            </div>
                            <div class="text">
                                <h3 class="mb-0"><a href="project_details.php"> الموهبة #1 </a></h3>
                            </div>
                    ...
                    <div class="item">
                        <div class="car-wrap ftco-animate">
                            <div class="img d-flex align-items-end" style="background-image: url(uploads/fash2.jpg);">
                            </div>
                            <div class="text">
                                <h3 class="mb-0"><a href="project_details.php"> الموهبة #1 </a></h3>
                            </div>
            ...
            <div class="all-vec">
                <a href="artificial_project.php" class="btn text-center button m-auto">
                    <?php echo $lang["fash_int_all_project"] ?> </a>
            </div>
        </div>
    </div>
</section>
