...
<div class="hero artif">
    <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                ...
                <img src="uploads/sport.jpg" class="d-block w-100" alt="image1">
            </div>
            <div class="carousel-item">
                <div class="overlay"> </div>
                <img src="uploads/sport1.jpg" class="d-block w-100" alt="image2">
            </div>
            <div class="carousel-item">
                <div class="overlay"> </div>
                <img src="uploads/sport3.jpg" class="d-block w-100" alt="image3">
            </div>
        </div>
    ...
    <div class="data container data_logo">
        ...
        <h2> <?php echo $lang["sport_int_head1"] ?></h2>
