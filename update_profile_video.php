...
<div class="cars hero faq">
    <div class="overlay">
        <div class="container data">
            <h2> <?php echo $lang['upload_your_video_here']; ?> </h2>
        </div>
    </div>
</div>
<!-- START PROFILE DATA -->
...
$count = $stmt->rowCount();
if ($count > 0) {
    include "update_profile_video/revival_register.php";
}
// artificial_register
...
$count = $stmt->rowCount();
if ($count  > 0) {
    include "update_profile_video/art_register.php";
}
...
$count = $stmt->rowCount();
if ($count > 0) {
    include "update_profile_video/sport_talent_register.php";
}
...
$count = $stmt->rowCount();
if ($count > 0) {
    include "update_profile_video/fash_register.php";
}
