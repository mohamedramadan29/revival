                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="box">
                            ...
                            <select id="cat_active2" class="form-control" name="email_section" id="">
                                ...
                                <option value="التسجيل في الكورس"> التسجيل في كورس  </option>
                                <option value="الموافقة علي التسجيل في الكورس">  تاكيد التسجيل في الكورس او الموافقة   </option>
                                <option value="الاشتراك في القائمة البريدية">الاشتراك في القائمة البريدية</option>
                                <option value="اضافة خبر جديد">اضافة خبر جديد</option>
                                <option value="اضافة مقال جديد">اضافة مقال جديد</option>
                            </select>
                        </div>
                    </div>
