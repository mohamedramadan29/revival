<div class="container">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="box">
                            ...
                            <textarea name="course_constructor_info_en" class="form-control" placeholder=" "></textarea>
                        </div>
                        <div class="box2">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="box">
                            ...
                            <textarea name="course_description_en" class="form-control"></textarea>
                        </div>
                        <div class="box">
        ...
        if (isset($_POST['add_car'])) {
            ...
            if (empty($formerror)) {
                ...
                $stmt->execute([
                    ...
                    'zcourse_learn_en' => $course_learn_en,
                    'zcourse_reqirement' => $course_requirement,
                    'zcourse_reqirement_en' => $course_requirement_en,
                    'zcourse_description' => $course_description,
                    'zcourse_description_en' => $course_description_en,
                    'zcourse_how' => $how_course,
                    'zcourse_how_en' => $how_course_en,
    ...
    <div class="alert-success">
        ...
        <?php header('refresh:3;url=main.php?dir=courses&page=report'); ?>
    </div>
