                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="box">
                                    ...
                                    <input required class="form-control" type="text" name="banner_name" value="<?php echo $alltype["banner_name"]; ?>">
                                </div>
                                <div class="box">
                                    <label id="name"> عنوان البانر
                                    </label>
                                    <input required class="form-control" type="text" name="banner_head" value="<?php echo $alltype["banner_head"]; ?>" value="<?php echo $alltype["banner_head"]; ?>">
                                </div>
                                <div class=" box">
                                    <label id="name"> عنوان البانر باللغه الانجليزية
                                    </label>
                                    <input required class="form-control" type="text" name="banner_head_en" value="<?php echo $alltype["banner_head_en"]; ?>">
                                </div>
                                <div class="box">
                                    <label id="name"> وصف البانر
                                    </label>
                                    <input required class="form-control" type="text" name="banner_desc" value="<?php echo $alltype["banner_desc"]; ?>">
                                </div>

                                <div class="box">
                                    <label id="name"> وصف البانر باللغه الانجليزية
                                    </label>
                                    <input required class="form-control" type="text" name="banner_desc_en" value="<?php echo $alltype["banner_desc_en"]; ?>">
                                </div>
                                ...
                                <div class="box">
                                    ...
                                    <select class="form-control" name="banner_page" id="cat_active6">
                                        <option value="">
                                            اختر الصفحة </option>
                                        <option <?php if ($alltype["banner_page"] == "الرئيسية") echo "selected"; ?> value="الرئيسية"> الرئيسية </option>
