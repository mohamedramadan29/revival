                ...
                <tbody> <?php
                        ...
                        <td>
                            <a class=" btn btn-success"
                                href="main.php?dir=fash_register&page=edit&register_id=<?php echo $type['fash_register_id']; ?> ">
                                <i class="fa fa-edit"></i>
                            </a>
                            <a class="confirm btn btn-danger"
                                href="main.php?dir=fash_register&page=delete&register_id=<?php echo $type['fash_register_id']; ?> ">
