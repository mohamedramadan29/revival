    ...
    <div class="data">
        <div class="bread">
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"> تسجيلات الازياء والموضه </li>
                </ol>
            </nav>
        </div>
        <div class="title text-right">
            <h6> <i class="fa fa-search"></i> تسجيلات الازياء والموضه </h6>
        </div>
        <!-- Content Row -->
        <div class="table-responsive">
            <table id="table" class="table table-light table-striped table-hover table-bordered">
                ...
                <tbody> <?php
                        $stmt = $connect->prepare('SELECT * FROM fash_register');
                        $stmt->execute();
                        ...
                        foreach ($alltype as $type) { ?> <tr>
                            ...
                            <td>
                                <a class=" btn btn-success" href="main.php?dir=fash_register&page=edit&register_id=<?php echo $type['fash_register_id']; ?> ">
                                    <i class="fa fa-edit"></i>
                                </a>
                                <a class="confirm btn btn-danger" href="main.php?dir=fash_register&page=delete&register_id=<?php echo $type['fash_register_id']; ?> ">
