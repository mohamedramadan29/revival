...
?>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="box">
                                    ...
                                    <input class="form-control" type="text" name="car_name" value="<?php echo $alltype['project_name']; ?>">
                                </div>
                                <div class="box">
                                    <label id="name"> مجال المشروع </label>
                                    <input class="form-control" type="text" name="car_name" value="<?php echo $alltype['project_field']; ?>">
                                </div>
                                <div class="box">
                                ...
                                <div class="box">
                                    ...
                                    <input class="form-control" type="date" name="car_name" value="<?php echo $alltype['project_date']; ?>">
                                </div>


                                <div class="box">
                                    <label id="name"> ماهي التقنيات المستخدمة فى انجاز المشروع </label>
                                    <input class="form-control" type="text" name="car_name" value="<?php echo $alltype['project_tools']; ?>">
                                </div>
                                ...
                                <div class="box">
                                    ...
                                    <textarea name="" class="form-control"><?php echo $alltype['project_competation']; ?></textarea>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="box">
                                    ...
                                    <input class="form-control" type="text" name="car_name" value="<?php echo $alltype['register_type']; ?>">
                                </div>
                                <div class="box">
                                ...
                                <div class="box">
                                    ...
                                    <select class="form-control" name="user_show" id="">
                                        ...
                                        <option <?php if ($alltype['user_show'] == 'نعم')  echo 'selected'; ?> value="نعم"> نعم </option>
                                        <option <?php if ($alltype['user_show'] == 'لا')  echo 'selected'; ?> value="لا"> لا </option>
                                    </select>
                                </div>
    ...
    <?php
                ...
                $stmt = $connect->prepare("SELECT * FROM art_register WHERE user_status = 'active' AND art_register_id  =?  ");
