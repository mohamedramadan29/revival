...
if (isset($_GET['select_id']) && is_numeric($_GET['select_id'])) {
    ...
    $stmt = $connect->prepare('SELECT * FROM  form_selection WHERE select_id=?');
...
<div class="container">
    ...
    <div class="data">
        ...
        <div class="title text-right">
            <h6> <i class="fa fa-edit"></i>تعديل محتوي المجالات الاساسية</h6>
        </div>
        <div class="myform">
                ...
                <div class="row">
                    ...
                    <div class="box">
                        ...
                        <div class="box">
                            ...
                            <select class="form-control" name="select_form" id="cat_active6">
                                <option value="">
                                    اختر الفورم </option>
                                <option <?php if ($alltype["select_form"] == "ريفايفال") echo "selected"; ?>
                                    value="ريفايفال"> ريفايفال </option>
                                <option <?php if ($alltype["select_form"] == "مدينة الذكاء الإصطناعي") echo "selected"; ?>
                                    value="مدينة الذكاء الإصطناعي"> مدينة الذكاء الإصطناعي </option>
                                <option <?php if ($alltype["select_form"] == "مواهب العالم الرياضية") echo "selected"; ?>
                                    value="مواهب العالم الرياضية"> مواهب العالم الرياضية </option>
                                <option <?php if ($alltype["select_form"] == "الأزياء والمجوهرات") echo "selected"; ?>
                    ...
                    <div class="box">
                        ...
                        <div class="box">
                            <label id="name">   المجالات  الفرعية الانجليزية
                            </label>
                            <textarea name="select_sub_name_en" class="form-control"  placeholder="من فضلك افصل بين  كل مجال والاخر ب (,)"><?php echo $alltype["select_sub_name_en"] ?></textarea>
                        </div>
                    </div>
...
<?php if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $select_sub_name =  $_POST['select_sub_name'];
  $select_name_en = $_POST['select_name_en'];
  $select_sub_name_en = $_POST['select_sub_name_en'];
  $select_form =   $_POST['select_form'];
            ...
            if (empty($formerror)) {
                ...
                $stmt = $connect->prepare("UPDATE form_selection SET 
                    select_name=?,select_sub_name=?,select_name_en=?,
                    select_sub_name_en=?,select_form=?
                WHERE select_id=?");
                $stmt->execute([
                    $select_name,
                    $select_sub_name,
