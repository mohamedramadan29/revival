<div class="container">
    <div class="data">
        ...
        <div class="title text-right">
            <h6> <i class="fa fa-plus"></i> الاخبار </h6>
        </div>
        <div class="myform">
            <form class="form-group insert" method="POST" autocomplete="on" enctype="multipart/form-data">
                <div class="row">
                    ...
                    <div class="box submit_box">
                        <input class="btn btn-primary" name="add_car" type="submit" value="اضافه خبر  جديد">
                    </div>
                </div>
            </form>
        </div>
    ...
    <?php if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        if (isset($_POST['add_car'])) {
            ...
            if (empty($formerror)) {
                ...
                $stmt = $connect->prepare("INSERT INTO news (new_title,new_title_en,
