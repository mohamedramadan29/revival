        ...
        <div class="table-responsive">
            <table id="table" class="table table-light table-striped table-hover table-bordered">
                ...
                <tbody> <?php
                        ...
                        <td><?php echo $type['first_name2']; ?> </td>
                        ...
                        <td>
                            <a class=" btn btn-success"
                                href="main.php?dir=sport_register&page=edit&register_id=<?php echo $type['sport_register_id']; ?> ">
                                <i class="fa fa-edit"></i>
                            </a>
                            <a class="confirm btn btn-danger"
                                href="main.php?dir=sport_register&page=delete&register_id=<?php echo $type['sport_register_id']; ?> ">
