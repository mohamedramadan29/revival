...
?>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="box">
                                    ...
                                    <input class="form-control" type="text" name="car_name" value="<?php echo $alltype['first_name2']; ?>">
                                </div>
                                <div class="box">
    ...
    <?php
                ...
                $stmt = $connect->prepare("SELECT * FROM sport_register WHERE user_status = 'active' AND sport_register_id =?  ");
