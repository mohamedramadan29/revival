                    ...
                    <div class="col-lg-6">
                        <div class="box">
                            ...
                            <input required class="form-control" type="text" name="goal_head"
                                value="<?php echo $alltype["goal_head"]; ?>">
                        </div>
                        <div class="box">
                            <label id="name"> عنوان الاهداف الانجليزية
                            </label>
                            <input required class="form-control" type="text" name="goal_head_en"
                                value="<?php echo $alltype["goal_head_en"]; ?>">
                        </div>
                        <div class="box">
                            <label id="name"> الوصف
                            </label>
                            <textarea name="goal_desc" id=""
                                class="form-control"><?php echo $alltype["goal_desc"]; ?></textarea>

                        </div>
                        <div class="box">
                            <label id="name"> الوصف باللغه الانجليزية
                            </label>
                            <textarea name="goal_desc_en" id=""
                                class="form-control"><?php echo $alltype["goal_desc_en"]; ?></textarea>
                        ...
                        <div class="box">
                            ...
                            <input required class="form-control" type="text" name="vision_head"
                                value="<?php echo $alltype["vision_head"]; ?>">
                        </div>
                        <div class="box">
                            <label id="name"> عنوان رويتنا الانجليزية
                            </label>
                            <input required class="form-control" type="text" name="vision_head_en"
                                value="<?php echo $alltype["vision_head_en"]; ?>">
                        </div>

                        <div class="box">
                            <label id="name"> الوصف
                            </label>
                            <textarea name="vision_desc" id=""
                                class="form-control"><?php echo $alltype["vision_desc"]; ?></textarea>

                        </div>
                        <div class="box">
                            <label id="name"> الوصف باللغه الانجليزية
                            </label>
                            <textarea name="vision_desc_en" id=""
                                class="form-control"><?php echo $alltype["vision_desc_en"]; ?></textarea>
                    ...
                    <div class="col-lg-6">
                        <div class="box">
                            ...
                            <input required class="form-control" type="text" name="message_head"
                                value="<?php echo $alltype["message_head"]; ?>">
                        </div>
                        <div class="box">
                            <label id="name"> عنوان رسالتنا الانجليزية
                            </label>
                            <input required class="form-control" type="text" name="message_head_en"
                                value="<?php echo $alltype["message_head_en"]; ?>">
                        </div>

                        <div class="box">
                            <label id="name"> الوصف
                            </label>
                            <textarea name="message_desc" id=""
                                class="form-control"><?php echo $alltype["message_desc"]; ?></textarea>

                        </div>
                        <div class="box">
                            <label id="name"> الوصف باللغه الانجليزية
                            </label>
                            <textarea name="message_desc_en" id=""
                                class="form-control"><?php echo $alltype["message_desc_en"]; ?></textarea>
