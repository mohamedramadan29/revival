...
if (isset($_GET['register_id']) && is_numeric($_GET['register_id'])) {
    ...
    $stmt = $connect->prepare('SELECT * FROM artificial_event_register WHERE reg_id=?');
            ...
            <form class="form-group insert" method="POST" autocomplete="on" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <?php
                        ...
                        $stmt->execute(array($alltype['event_id']));
...
<?php if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            ...
            $stmt = $connect->prepare("UPDATE artificial_event_register SET user_status=? WHERE reg_id=? ");
            $stmt->execute([
                $user_status, 
                $register_id,
            ]);
