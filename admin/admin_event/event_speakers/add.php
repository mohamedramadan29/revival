                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="box">
                            ...
                            <input type="text" class="form-control" name="speaker_name_en">
                        </div>
                        <div class="box">
                        ...
                        <div class="box">
                            ...
                            <input type="text" class="form-control" name="speaker_jop_en">
                        </div> 
    ...
    <?php if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        if (isset($_POST['add_car'])) {
            ...
            $stmt = $connect->prepare("INSERT INTO event_speaker
                (speaker_name,speaker_name_en,speaker_jop,speaker_jop_en,image1,image2,event_page)
                VALUES (:zspeaker_name,:zspeaker_name_en,:zspeaker_jop,:zspeaker_jop_en,:zimage,:zimage_en,:zevent_page)");
            $stmt->execute([
                'zspeaker_name' => $speaker_name,
                'zspeaker_name_en' => $speaker_name_en,
                'zspeaker_jop' => $speaker_jop,
                'zspeaker_jop_en' => $speaker_jop_en,
