                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="box">
                                    ...
                                    <input type="text" class="form-control" name="sponser_name_en" value="<?php echo $alltype["sponser_name_en"]; ?>">
                                </div>
                                <div class="box">
                                    <label id="name"> الرابط
                                    </label>
                                    <input placeholder="" type="url" class="form-control" name="sponser_link" value="<?php echo $alltype["sponser_link"]; ?>">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="box2">
        ...
        move_uploaded_file(
            ...
            if (empty($formerror)) {
                ...
                $stmt = $connect->prepare("UPDATE event_sponser SET 
                    sponser_name=?,sponser_name_en=?,sponser_link=?,event_page=?
                WHERE sponser_id =?");
                $stmt->execute([
                    $sponser_name,
                    $sponser_name_en,
                ...
                if ($image_image1_tem != "" && $image_image2_tem != "") {
                    $stmt = $connect->prepare("UPDATE event_sponser SET image1=?,image2=?
                    WHERE sponser_id =?");
                    $stmt->execute([
                        $image_image1_uploaded,
                        $image_image2_uploaded,
                ...
                elseif($image_image2_tem != "") {
                    $stmt = $connect->prepare("UPDATE event_sponser SET image2=?
                    WHERE sponser_id =?");
                    $stmt->execute([
                        $image_image2_uploaded,
                        $sponser_id,
