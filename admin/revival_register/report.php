<div class="container customer_report">
    <div class="data">
        ...
        <div class="title text-right">
            <h6> <i class="fa fa-search"></i> تسجيلات ريفايفال </h6>
        </div>
        <!-- Content Row -->
        <div class="table-responsive">
            <table id="table" class="table table-light table-striped table-hover table-bordered">
                ...
                <tbody> <?php
                        $stmt = $connect->prepare('SELECT * FROM register');
                        $stmt->execute();
                        ...
                        foreach ($alltype as $type) { ?> <tr>
                            ...
                            <td>
                                <a class=" btn btn-success" href="main.php?dir=revival_register&page=edit&register_id=<?php echo $type['reg_id']; ?> ">
                                    <i class="fa fa-edit"></i>
                                </a>
                                <a class="confirm btn btn-danger" href="main.php?dir=revival_register&page=delete&register_id=<?php echo $type['reg_id']; ?> ">
