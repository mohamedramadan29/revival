                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="box">
                            ...
                            <textarea required name="term_data" id="" class="form-control" placeholder="من فضلك افصل بين كل نقطة والاخري ب(,)"></textarea>
                        </div>

                        <div class="box">
                            <label id="name"> اضافة الشروط باللغه الانجليزية
                            </label>
                            <textarea required name="term_data_en" id="" class="form-control" placeholder="من فضلك افصل بين كل نقطة والاخري ب(,)"></textarea>
                        </div>
