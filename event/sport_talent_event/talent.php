    ...
    <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                ...
                <img src="../../uploads/sport2.jpg" class="d-block w-100" alt="image2">
            </div>
            <div class="carousel-item">
                <div class="overlay"> </div>
                <img src="../../uploads/sport.jpg" class="d-block w-100" alt="image3">
            </div>
        </div>
            ...
            <div class="row info_data">
                <div class="col-lg-6 col-12">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><i class="fa fa-star"></i> <?php echo $lang["index_p17"]; ?>
                        </li>
...
<div class="art_filed_main_active">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="info">
                    <h4> <?php echo $lang["participate_h1"]; ?> </h4>
                    <ul class="list-unstyled">
                        <li> <i class="fa fa-star"></i> <?php echo $lang["participate_p1"]; ?></li>
                        <li> <i class="fa fa-star"></i> <?php echo $lang["participate_p2"]; ?> </li>
                        <li> <i class="fa fa-star"></i> <?php echo $lang["participate_p3"]; ?></li>
                        <li> <i class="fa fa-star"></i> <?php echo $lang["participate_p4"]; ?> </li>
                        <li> <i class="fa fa-star"></i> <?php echo $lang["participate_p6"]; ?>
                        </li>
                        <li> <i class="fa fa-star"></i> <?php echo $lang["participate_p7"]; ?> </li>
                        <li> <i class="fa fa-star"></i> <?php echo $lang["participate_p8"]; ?> </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12 heading-section text-center ftco-animate mb-5">
                <h2 class="mb-2"> <?php echo $lang["sponser"]; ?> </h2>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
