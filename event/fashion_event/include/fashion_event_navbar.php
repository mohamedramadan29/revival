		            ...
		            <div class="col-lg-6">
		                <ul class="list-unstyled login_links">
		                    ...
		                    <li class="change_lang"> <button class="btn btn-default btn-sm" type="button" name="button"> <a
		                                href="fashion.php?lang=en"> English </a> </button> </li>
		                    <?php } else { ?>

		                    <li class="change_lang"> <button class="btn btn-default btn-sm" type="button" name="button"> <a
		                                href="fashion.php?lang=ar"> عربي </a> </button> </li>
		                    <?php } ?>
		                    <li class="nav-item">
		...
		<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light">
		    <div class="container-fluid">
		        <a class="navbar-brand" href="index.php"><img class="logo_class" src="../../uploads/ai2.jpg" alt=""></a>
		        ...
		        <div class="collapse navbar-collapse" id="navbarSupportedContent">
		            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
		                ...
		                <li class="nav-item">
		                    <a class="nav-link" href="fashion.php"> <?php echo $lang["fashion"] ?> </a>
		                </li>
		                <li class="nav-item">
		                    <a class="nav-link" href="#about_event"> <?php echo $lang["about_event"] ?></a>
		                </li>
		                <li class="nav-item">
		                    <a class="nav-link" href="#goals"> <?php echo $lang["goals"] ?> </a>
		                </li>
		                <li class="nav-item">
