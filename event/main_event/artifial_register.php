...
<div class="cars hero faq booking">
    <div class="overlay">
        <div class="container data">
            <h2> Register Now In Artificial Intelligence </h2>
        </div>
    </div>
</div>
<!-- END HERO SECTION -->
                ...
                <div class="col-lg-4 cars_sections">
                    <div class="item">
                        <div class="car-wrap rounded ftco-animate">
                            ...
                            <div class="text">
                                <h2 class="mb-0"><a href="#">ARTIFICIAL INTELLIGENCE</a></h2>

                                <div class="terms_conditions">
                                    <input type="checkbox" id="checkterms">
                                    <label for="checkterms"> I agree to the <a href="privacy_policy.php"> terms and
                                            conditions </a>
                                    </label>
                                </div>
                                <hr>
