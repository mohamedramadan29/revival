...
$lang = array(
  ...
  "index_h2" => "  The city of artificial intelligence and virtual reality",
  "index_h3" => "Aivr City",

  "index_p1" => "The City of Artificial Intelligence and Virtual Reality is a smart and technical city that has a presence in the real, virtual and augmented reality. It invests in knowledge and invents artificial intelligence devices in various fields to be supportive in both real and virtual reality. It works to develop special and innovative economic and social projects in the world of metaverses with the minds of the geniuses of the Arab and Islamic world to draw ...",
  "index_why_h" => "   Why AIVR City?  ",
  "index_p2" => "The city of artificial intelligence and virtual reality is a smart and technical city that has a presence in reality
    Real, virtual and augmented, invests in knowledge and innovation of artificial intelligence devices in the fields
    different to be supportive in real and virtual reality.
 
    It works to develop special and innovative economic and social projects in the world of metavirs with the minds of the world's geniuses
    Arab and Islamic to chart the future of metavirus and support technical development in the world through investment
    Talented minds and technical research support in a new and innovative interactive way, contributing to achieving sustainable growth
  ...
  "index_p10" => "talented",
  "index_p12" => " Factories and companies  ",
  "index_p13" => " Investors ",
  "index_p14" => " Governments  ",
  "index_p16" => "Experts in the field of Artificial Intelligence and Metavirus ",
  ...
  "art_int_reg_head1" => " Register Now In Artificial Intelliegence  ",
  ...
  "art_register_h1" => "Register Now In Artificial Intelliegence",
  ...
  "sch_h2" => " Artificial Intelligence and Virtual Reality City Program  ",


  "sch_h3" => " First day  ",
  "sch_h4" => " Transferring the real reality with its institutions and technologies from the virtual reality to the world of metavirs in a creative way that simulates reality to keep pace with global development ",
  ...
  ///////////////////////////// newwww
  "complete_reser_pro" => "Complete the reservation process ",

  "fants" => " wonderful ! ",
  "reserv_add_to_cart_suc" => "The reservation has been successfully added to the cart",
  "matches_table" => "  Match schedule available ",
  "event_name" => " Event Name ",
    "event_title" => " Title ",
    "event_date" => " Date ",
  "matches" => "  Matches  ",
  ...
  "book_matches" => " Book Matches ",
  "first_team" => "  First Team  ",
  "second_team" => "  Second Team  ",
  "match_date" => "  Match Date ",
  "match_time" => "   Match Time ",
  "match_place" => " Match Place ",
  "match_price" => "  Match Price ",
  "sc_av_courses" => " Schedule of available courses ",
  "courses" => "     Courses    ",
  "course_reserv" => "   Course booking ",
  "course_name" => " Course Name ",
  "course_date"=>" Course Date ", 
  "course_time"=>"   Course time ", 
  "course_place"=>"  Course Place ", 
  "course_instructor"=>" Course Instructor  ", 
  "course_days_num"=>"  Course Days Num   ", 
  "course_num_hour"=>"   The number of hours of the course  ", 
  "course_price"=>"   Course Price   ", 
  "reserv_all_day"=>"  Full day reservation   ", 
  "the_day"=>"  Day   ", 
  "price"=>" Price   ", 
  "watch_cart"=>" View reservations  ",  
////////
"match_is_reserv"=>"  Matches booked  ",  
"course_booking"=>" Course bookings ",  
"reserve_all_days"=>" Full day reservations ", 
"event_address"=>" Event Title ", 
"payment_is_completed"=>" Payment is completed ",
"early_registration"=>" Early registration price ",
