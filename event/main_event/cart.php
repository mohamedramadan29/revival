    ...
    ?>
            ...
            <div class='cart_section'>
                ...
                <div class='table-responsive'>
                    <table
                        class='table text-center table-resposive table-hover table-bordered align-middle table-striped'>
                        <thead>
                            <tr>
        ...
        foreach ( $alldata as $value ) {
            ...
            ?> </td>
                                <td>
                                    <?php echo $value[ 'match_price' ];
            ?> <span> $ </span>
                                </td>
                                <!--
                                <td> <a href="deleteitem.php?id=<?php echo $value[
            'prog_id'
        ]; ?>&event_id=<?php echo $event_id; ?>" class='btn btn-danger'> <i class='fa fa-trash'></i> </a> </td>
        -->
                            </tr>
                            <?php
        }
