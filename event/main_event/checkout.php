                                ...
                                <div class="col-lg-6 col-12">
                                    <div class="box mb-3">
                                        ...
                                        <input type="hidden" id="total_price" name="total_price"
                                            value="<?php echo $total_prices ?>">
                                        <input type="hidden" name="payment_mode" value="COD">
                                        <!-- Match Reservation -->
                                        <input type="hidden" id="sport_reservation" name="sport_reservation"
                                            value="<?php echo $sport_reservation; ?>">
                                        <input type="hidden" id="train_reservation" name="train_reservation"
                                            value="<?php echo $train_reservation; ?>">
                                        <input type="hidden" id="all_day_reservation" name="all_day_reservation"
                                            value="<?php echo $all_day_reservation; ?>">
...
<script
    src="https://www.paypal.com/sdk/js?client-id=Aa6xGlT7CdEYFS463meNhvyq6Tovq_rlYBK0U2pEMalXKRMy-1GxSFwAd6_UrMFQkaYxQRn-Dop6Gk61&currency=USD">
</script>
