				...
				<div class="col-lg-6">
					<ul class="list-unstyled login_links">
						<?php if ($_SESSION['lang'] == 'ar') { ?>
							<li class="change_lang"> <button class="btn btn-default btn-sm" type="button" name="button"> <a href="events.php?lang=en"> English </a> </button> </li>
						<?php } else { ?>

							<li class="change_lang"> <button class="btn btn-default btn-sm" type="button" name="button"> <a href="events.php?lang=ar"> عربي </a> </button> </li>
						<?php } ?>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					$stmt->execute();
					$allactiveevent = $stmt->fetchAll();
					foreach ($allactiveevent as $event) { ?>
						<li class="nav-item">
							<a class="nav-link" href="main_event?event_id=<?php echo $event["event_id"]; ?>"> <?php
							if($_SESSION["lang"] == "ar"){
								echo $event["event_name"];
							}else{
								echo $event["event_name_en"];
							}
							?></a>
						</li>
					<?php
