...
<div class="container">
    ...
    <div class="data">
        ...
        <div class="title text-right">
            <h6> <i class="fa fa-edit"></i> المقالات </h6>
        </div>
        <div class="myform">
            <form class="form-group insert" method="POST" autocomplete="on" enctype="multipart/form-data">
                <input type="hidden" name="typ_id" value="<?php echo $article_id; ?>">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="box">
                        ...
                        <div class="box">
                            ...
                            <select id="cat_active2" class="form-control" name="category" id="">
                                ...
                                <option value="art_int"
                                    <?php if ($alltype["article_category"] == "art_int") echo "selected";  ?>> الذكاء
                                    الاصطناعي </option>
                                <option value="sport"
                                    <?php if ($alltype["article_category"] == "sport") echo "selected";  ?>> الرياضة
                                </option>
                                <option value="fashion"
                                    <?php if ($alltype["article_category"] == "fashion") echo "selected";  ?>> الازياء
                                    والموضة </option>
                    ...
                    <div class="col-lg-6">
                        <div class="box">
                            ...
                            <textarea name="answer1" id=""
                                class="form-control">  <?php echo $alltype["article_desc"]; ?> </textarea>
                        </div>
                        <div class="box">
                            <label for=""> محتوي المقال باللغه الانجليزية </label>
                            <textarea name="answer2" id=""
                                class="form-control"> <?php echo $alltype["article_desc_en"]; ?></textarea>
                        </div>
                    </div>
                    <div class="box submit_box">
                        <input class="btn btn-primary" name="add_car" type="submit" value="تعديل المقال">
                    </div>
                </div>
            </form>
        </div>
