                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="box">
                            ...
                            <select class="form-control" name="term_page" id="cat_active6">
                                <option value="">
                                    اختر الصفحة </option>
                                <option <?php if ($alltype["term_page"] == "الرئيسية") echo "selected"; ?>
                                    value="الرئيسية"> الرئيسية </option>
                                <option
                                    <?php if ($alltype["term_page"] == "مدينة الذكاء الإصطناعي") echo "selected"; ?>
                                    value="مدينة الذكاء الإصطناعي"> مدينة الذكاء الإصطناعي </option>
                                <option <?php if ($alltype["term_page"] == "مواهب العالم الرياضية") echo "selected"; ?>
                                    value="مواهب العالم الرياضية"> مواهب العالم الرياضية </option>
                                <option <?php if ($alltype["term_page"] == "الأزياء والمجوهرات") echo "selected"; ?>
                        ...
                        <div class="box">
                            ...
                            <textarea required name="term_data" id="" class="form-control"
                                placeholder="من فضلك افصل بين كل نقطة والاخري ب(,)"><?php echo $alltype["term_data"]; ?></textarea>
                        </div>
                        ...
                        <div class="box">
                            ...
                            <textarea required name="term_data_en" id="" class="form-control"
                                placeholder="من فضلك افصل بين كل نقطة والاخري ب(,)"><?php echo $alltype["term_data_en"]; ?></textarea>
                        </div>
