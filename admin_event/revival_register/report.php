    ...
    <div class="data">
            ...
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"> <i class="fa fa-heart"></i> <a
                            href="main.php?dir=dashboard&page=dashboard">  تسجيلات الاحداث  </a> <i
                            class="fa fa-chevron-left"></i> </li>
                    <li class="breadcrumb-item active" aria-current="page"> تسجيلات الاحداث </li>
                </ol>
            </nav>
        </div>
        <div class="title text-right">
            <h6> <i class="fa fa-search"></i> تسجيلات الاحداث </h6>
        </div>
        <!-- Content Row -->
        <div class="table-responsive">
            <table id="table" class="table table-light table-striped table-hover table-bordered">
                ...
                <tbody> <?php
                        $stmt = $connect->prepare('SELECT * FROM artificial_event_register');
                        $stmt->execute();
                        ...
                        <td>
                            <a class=" btn btn-success btn-sm"
                                href="main.php?dir=revival_register&page=edit&register_id=<?php echo $type['reg_id']; ?> ">
                                <i class="fa fa-edit"></i>
                            </a>
                            <a class="confirm btn btn-danger btn-sm"
                                href="main.php?dir=revival_register&page=delete&register_id=<?php echo $type['reg_id']; ?> ">
