<div class="container">
    <div class="data">
        ...
        <div class="title text-right">
            <h6> <i class="fa fa-plus"></i>  اختيارات الفورم </h6>
        </div>
        <div class="myform">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="box">
                            ...
                            <select required class="form-control" name="select_form" id="cat_active6">
                                ...
                                <option value="ريفايفال"> ريفايفال </option>
                    ...
                    <div class="col-lg-6">
                        <div class="box">
                            ...
                            <textarea name="select_sub_name" class="form-control" placeholder="من فضلك افصل بين  كل مجال والاخر ب (,)"></textarea>
                        </div>
                        <div class="box">
                            <label id="name">   المجالات الفرعية الانجليزية
                            </label>
                            <textarea name="select_sub_name_en" class="form-control"  placeholder="من فضلك افصل بين  كل مجال والاخر ب (,)"></textarea>
                        </div>
    ...
    <?php if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        if (isset($_POST['add_car'])) {
            ...
            if (empty($formerror)) {
                ...
                $stmt = $connect->prepare("INSERT INTO form_selection
                 (select_name,select_sub_name, select_name_en,select_sub_name_en ,select_form )
                VALUES (:zselect_name,:zselect_sub_name,:zselect_name_en,:zselect_sub_name_en,:zselect_form)");
                $stmt->execute([
                    'zselect_name' => $select_name,
                    'zselect_sub_name' => $select_sub_name,
                    'zselect_name_en' => $select_name_en,
                    'zselect_sub_name_en' => $select_sub_name_en,
                    'zselect_form' => $select_form,
                ]);
                if ($stmt) { ?>
    <div class="alert-success">
        تم اضافة محتوي جديد بنجاح
        <?php header('refresh:0;url=main.php?dir=form_selection&page=report'); ?>
    </div>
</div>
<?php }
            }
