                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="box">
                            ...
                            <input placeholder="https://www.google.com" type="url" class="form-control" name="sponser_link">
                        </div> 
    ...
    <?php if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        if (isset($_POST['add_car'])) {
            ...
            $stmt = $connect->prepare("INSERT INTO event_sponser
                (sponser_name,sponser_link,image1,event_page)
                VALUES (:zsponser_name,:zsponser_link,:zimage,:zevent_page)");
            $stmt->execute([
