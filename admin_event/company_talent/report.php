                ...
                <tbody> <?php
                        ...
                        <td>
                            <a class=" btn btn-success"
                                href="main.php?dir=company_register&page=edit&register_id=<?php echo $type['art_register_id']; ?> ">
                                <i class="fa fa-edit"></i>
                            </a>
                            <a class="confirm btn btn-danger"
                                href="main.php?dir=company_register&page=delete&register_id=<?php echo $type['art_register_id']; ?> ">
