                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="box">
                                    ...
                                    <input required class="form-control" type="text" name="banner_name" value="<?php echo $alltype["contact_name"]; ?>">
                                </div>
                                <div class="box">
                                    <label id="name"> البريد الالكتروني
                                    </label>
                                    <input required class="form-control" type="text" name="banner_name" value="<?php echo $alltype["contact_email"]; ?>">
                                </div>
                                <div class="box">
                                    <label id="name"> عنوان الرسالة
                                    </label>
                                    <input required class="form-control" type="text" name="banner_name" value="<?php echo $alltype["contact_head"]; ?>">
                                </div>
                                <div class=" box">
                                    <label id="name"> محتوي الرسالة
                                    </label>
                                    <textarea name="contact_message" class="form-control"><?php echo $alltype["contact_message"]; ?></textarea>
                                </div>

                                <div class="box">
                                    <label id="name"> تاريخ الرسالة
                                    </label>
                                    <input required class="form-control" type="text" name="contact_date" value="<?php echo $alltype["contact_date"]; ?>">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="box">
                                        ...
                                        ?>
                                                <div class="col-12">
                                                    ...
                                                    <div class="files_style">
                                                        <p> <a class="btn bg-gradient-light" target="_blank" href="../admin/upload/<?= $files1[$i] ?>">
