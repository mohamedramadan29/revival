<div class="container">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="box">
                            ...
                            <select id="cat_active2" class="form-control" name="email_section" id="">
                                ...
                                <option value="تواصل من الصفحة الرئيسية"> تواصل من الصفحة الرئيسية الاحداث </option>
                                <option value="تواصل من الحدث"> تواصل من الحدث </option>
                                <option value="شارك في الفعالية"> شارك في الفعالية </option>
    ...
    <?php if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        if (isset($_POST['add_car'])) {
            ...
            if (empty($formerror)) {
                $stmt = $connect->prepare("INSERT INTO email_message_event (email_text,email_text_en,
                email_section)
